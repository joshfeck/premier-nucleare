...
function nucleare_color_primary_register( $wp_customize ) {
	...
	*/
	$wp_customize->add_section( 'cresta_nucleare_options', array(
	     'title'    => esc_attr__( 'Nucleare Theme Options', 'nucleare' ),
	     'priority' => 50,
	) );
	...
	*/
        ...
        public function render_content() {  ?>
        	<p class="nucleare-upgrade-title">
        		<span class="customize-control-title">
					<h3 style="text-align:center;"><div class="dashicons dashicons-megaphone"></div> <?php _e('Get Nucleare PRO WP Theme for only', 'nucleare'); ?> 24,90&euro;</h3>
        		</span>
        	</p>
			<p style="text-align:center;" class="nucleare-upgrade-button">
				<a style="margin: 10px;" target="_blank" href="http://crestaproject.com/demo/nucleare-pro/" class="button button-secondary">
					<?php _e('Watch the demo', 'nucleare'); ?>
				</a>
				<a style="margin: 10px;" target="_blank" href="http://crestaproject.com/downloads/nucleare/" class="button button-secondary">
					<?php _e('Get Nucleare PRO Theme', 'nucleare'); ?>
				</a>
			</p>
			<ul>
				<li><div class="dashicons dashicons-yes" style="color: #1fa67a;"></div><b><?php _e( 'Advanced Theme Options', 'nucleare' ); ?></b></li>
				<li><div class="dashicons dashicons-yes" style="color: #1fa67a;"></div><b><?php _e( 'Logo Upload', 'nucleare' ); ?></b></li>
				<li><div class="dashicons dashicons-yes" style="color: #1fa67a;"></div><b><?php _e( 'Choose sidebar position', 'nucleare' ); ?></b></li>
				<li><div class="dashicons dashicons-yes" style="color: #1fa67a;"></div><b><?php _e( 'Loading Page', 'nucleare' ); ?></b></li>
				<li><div class="dashicons dashicons-yes" style="color: #1fa67a;"></div><b><?php _e( 'Font Switcher', 'nucleare' ); ?></b></li>
				...
				<li><div class="dashicons dashicons-yes" style="color: #1fa67a;"></div><b><?php _e( 'Sticky Sidebar', 'nucleare' ); ?></b></li>
				<li><div class="dashicons dashicons-yes" style="color: #1fa67a;"></div><b><?php _e( 'Post format', 'nucleare' ); ?></b></li>
				<li><div class="dashicons dashicons-yes" style="color: #1fa67a;"></div><b><?php _e( '7 Shortcodes', 'nucleare' ); ?></b></li>
				<li><div class="dashicons dashicons-yes" style="color: #1fa67a;"></div><b><?php _e( '10 Exclusive Widgets', 'nucleare' ); ?></b></li>
	...
	$wp_customize->add_section( 'cresta_upgrade_pro', array(
	     'title'    => __( 'More features? Upgrade to PRO', 'nucleare' ),
	     'priority' => 999,
	));
