...
function nucleare_scripts() {
	...
	wp_enqueue_style( 'nucleare-googlefonts', $protocol .'://fonts.googleapis.com/css?family=Playfair+Display:400|Archivo+Narrow:400,700');
	...
	global $wp_scripts;
	wp_enqueue_script( 'nucleare-html5shiv', get_template_directory_uri() . '/js/html5shiv.min.js', array(), '3.6', false );
	$wp_scripts->add_data( 'nucleare-html5shiv', 'conditional', 'lt IE 9' );
}
...
add_action( 'pre_get_posts', 'ee_view_all_events_search', 11 );
function ee_view_all_events_search( )
{
    global $wp_query;
